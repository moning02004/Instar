...
from app_main.mixin import IsLoginRequiredAndAjaxMixin, IsOwnerMixin
from app_user.forms import UserRegisterForm, UserLoginForm, UserProfileUpdateForm, UserPasswordUpdateForm
from app_user.models import User, UserImage
...
class UserUpdateProfile(IsOwnerMixin, UpdateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        request.user.save()
        return HttpResponseRedirect(reverse_lazy('app_user:profile', args=(request.user.id,)))

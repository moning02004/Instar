...
from apps.utils.mixin import IsOwnerMixin, IsLoginRequiredAndAjaxMixin
from apps.post.forms import PostUpdateForm
from apps.post.models import Post, File, Heart, Tag
...
def add_link(content):
    url = f'{reverse_lazy("post:list")}?search='
